...
{
    count=1
    let source=document.getElementById('song1').src='fear.mp3';
    document.getElementById('glimps').src='temp2.mp4'
    console.log(source)
...
function play2()
{
    count=2;
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='odiyamma.mp3';  
var audio=document.getElementById('song1')
...
function play3()
{
    count=3
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='hamma.mp3';  
var audio=document.getElementById('song1')
...
function play4()
{
    count=4
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='ohmybabay.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play5()
{
    count=5
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='kalki.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play6()
{
    ...
    console.log(count)
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='roja.mp3';  
var audio=document.getElementById('song1')
...
const node = document.createTextNode("Fear Devara");
...
function like21()
{
    ...
    const para = document.createElement("p");
    const node = document.createTextNode("Odiyamma");
    para.appendChild(node);
...
function like31()
{
    ...
    const node=document.createTextNode('Hamma Hamma')
...
function like41()
{
    ...
    const node=document.createTextNode('Oh My Baby')
    heading.appendChild(node)
    heading.onclick=()=>
        {
            document.getElementById('likedsongs').style.display='none'
...
function like51()
{
    ...
    const node=document.createTextNode('Ta Takkara')
    heading.appendChild(node)
    heading.onclick=()=>
        {
            document.getElementById('likedsongs').style.display='none'
...
function like61()
{
    ...
    const node=document.createTextNode('Na Roja Nuvve')
    heading.appendChild(node)
    heading.onclick=()=>
        {
            document.getElementById('likedsongs').style.display='none'
