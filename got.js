...
{
    count=1
    let source=document.getElementById('song1').src='kalkigod.mp3';
    document.getElementById('glimps').src='godmusic.mp4'
    console.log(source)
...
function play2()
{
    count=2;
    document.getElementById('glimps').src='godmusic.mp4'
document.getElementById('song1').src='damarukham.mp3';  
var audio=document.getElementById('song1')
...
function play3()
{
    count=3
    document.getElementById('glimps').src='godmusic.mp4'
document.getElementById('song1').src='kaleja.mp3';  
var audio=document.getElementById('song1')
...
function play4()
{
    count=4
    document.getElementById('glimps').src='godmusic.mp4'
document.getElementById('song1').src='damarukhamshiva.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play5()
{
    count=5
    document.getElementById('glimps').src='godmusic.mp4'
document.getElementById('song1').src='mukhundha.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play6()
{
    ...
    console.log(count)
    document.getElementById('glimps').src='godmusic.mp4'
document.getElementById('song1').src='devatha.mp3';  
var audio=document.getElementById('song1')
