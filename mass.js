...
{
    count=1
    let source=document.getElementById('song1').src='kurchi.mp3';
    document.getElementById('glimps').src='massmusic.mp4'
    console.log(source)
...
function play2()
{
    count=2;
    document.getElementById('glimps').src='massmusic.mp4'
document.getElementById('song1').src='dj.mp3';  
var audio=document.getElementById('song1')
...
function play3()
{
    count=3
    document.getElementById('glimps').src='massmusic.mp4'
document.getElementById('song1').src='hukum.mp3';  
var audio=document.getElementById('song1')
...
function play4()
{
    count=4
    document.getElementById('glimps').src='massmusic.mp4'
document.getElementById('song1').src='pedda.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play5()
{
    count=5
    document.getElementById('glimps').src='massmusic.mp4'
document.getElementById('song1').src='naik.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play6()
{
    ...
    console.log(count)
    document.getElementById('glimps').src='massmusic.mp4'
document.getElementById('song1').src='mind.mp3';  
var audio=document.getElementById('song1')
...
const node = document.createTextNode("Kurchi Madathapetti");
...
function like21()
{
    ...
    const para = document.createElement("p");
    const node = document.createTextNode("DJ Tillu");
    para.appendChild(node);
...
function like31()
{
    ...
    const node=document.createTextNode('Hukum')
...
function like41()
{
    ...
    const node=document.createTextNode('Pedda Pulli')
    heading.appendChild(node)
    heading.onclick=()=>
        {
            document.getElementById('likedsongs').style.display='none'
...
function like51()
{
    ...
    const node=document.createTextNode('Bheemla Nayak')
    heading.appendChild(node)
    heading.onclick=()=>
        {
            document.getElementById('likedsongs').style.display='none'
...
function like61()
{
    ...
    const node=document.createTextNode('Mind Block')
    heading.appendChild(node)
    heading.onclick=()=>
        {
            document.getElementById('likedsongs').style.display='none'
