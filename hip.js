...
{
    count=1
    let source=document.getElementById('song1').src='omg.mp3';
...
function play2()
{
    count=2;
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='psycho.mp3';  
var audio=document.getElementById('song1')
...
function play3()
{
    count=3
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='vikram.mp3';  
var audio=document.getElementById('song1')
...
function play4()
{
    count=4
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='hip.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play5()
{
    count=5
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='arya.mp3';  
var audio=document.getElementById('song1')
audio.currentTime=1.5
audio.play();
audio.addEventListener('ended',function()
...
function play6()
{
    ...
    console.log(count)
    document.getElementById('glimps').src='temp2.mp4'
document.getElementById('song1').src='lover.mp3';  
var audio=document.getElementById('song1')
